/*
 * The color palette system defined in this file is adapted from
 * the Kepler.gl source code.
 *
 * All credit for the original design and implementation of this
 * color palette system goes to the Kepler.gl team.
 *
...
export const D3_COLOR_CHROMATIC_SCHEME = {
    ...
    [PALETTE_TYPES.SEQ]: [
        'Viridis', 'Magma', 'Plasma', 'Cividis','CubehelixDefault','Warm', 'Cool'
    ],
    // [PALETTE_TYPES.DIV]: [],
...
const COLOR_BLIND_SAFE_MAP: Record<string, boolean> = {
    // colorbrewer
    BrBG: true,      // Brown-Blue-Green: Safe for color blind users
    PiYG: true,      // Pink-Yellow-Green: Safe
    PRGn: true,      // Purple-Green: Safe
    PuOr: true,      // Purple-Orange: Safe
    RdBu: true,      // Red-Blue: Safe
    RdGy: false,     // Red-Grey: Not safe
    RdYlBu: true,    // Red-Yellow-Blue: Safe
    RdYlGn: false,   // Red-Yellow-Green: Not safe
    Spectral: false, // Rainbow spectrum: Not safe

    // Qualitative schemes
    Accent: false,   // High contrast accents: Not safe
    Dark2: true,     // Dark colors: Safe
    Paired: true,    // Paired colors: Safe
    Pastel1: false,  // Light pastel: Not safe
    Pastel2: false,  // Light pastel: Not safe
    Set1: false,     // Bright set: Not safe
    Set2: true,      // Muted set: Safe
    Set3: false,     // Pastel set: Not safe

    // Sequential single-hue schemes
    Blues: true,     // Blue scale: Safe
    BuGn: true,      // Blue-Green: Safe
    BuPu: true,      // Blue-Purple: Safe
    GnBu: true,      // Green-Blue: Safe
    Greens: true,    // Green scale: Safe
    Greys: true,     // Grey scale: Safe
    Oranges: true,   // Orange scale: Safe
    OrRd: true,      // Orange-Red: Safe
    PuBu: true,      // Purple-Blue: Safe
    PuBuGn: true,    // Purple-Blue-Green: Safe
    PuRd: true,      // Purple-Red: Safe
    Purples: true,   // Purple scale: Safe
    RdPu: true,      // Red-Purple: Safe
    Reds: true,      // Red scale: Safe
    YlGn: true,      // Yellow-Green: Safe
    YlGnBu: true,    // Yellow-Green-Blue: Safe
    YlOrBr: true,    // Yellow-Orange-Brown: Safe
    YlOrRd: true,    // Yellow-Orange-Red: Safe

    // d3 scale chromatic
    Sinebow: true,           // Circular rainbow: Safe
    Rainbow: false,          // Traditional rainbow: Not safe
    Turbo: true,            // Improved rainbow: Safe
    Viridis: true,          // Yellow-Green-Blue: Safe
    Inferno: true,          // Yellow-Red-Purple: Safe
    Magma: true,            // White-Purple-Black: Safe
    Plasma: true,           // Blue-Red-Yellow: Safe
    Cividis: true,          // Blue-Yellow: Safe
    Warm: true,             // Warm temperature: Safe
    Cool: false,            // Cool temperature: Not safe
    CubehelixDefault: true, // Spiral in color space: Safe
    Tableau10: false        // Tableau's categorical: Not safe
};
